...
def view_dangerous_contents():
    print('*' * 60)
    print("Creating Report of All Dangerous Content Transports:")
    print('*' * 60)
    print()
    ...
    print()
    print('*' * 50)
    print("Dangerous Transport Report has been created!")
    print('*' * 50)
