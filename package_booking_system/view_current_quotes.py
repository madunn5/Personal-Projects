...
def view_active_quotes():
    print('*' * 50)
    print("Creating Report of Current Quotes:")
    print('*' * 50)
    print()
    ...
    try:
        with open('booking_quotes.csv', 'r') as csvfile:
            ...
            for row in reader:
                ...
                if delivery_date >= datetime.now() and route != 'Not Able to Be Shipped':
    ...
    print()
    print('*' * 50)
    print("Current Quotes Report has been created!")
    print('*' * 50)
