...
def view_unable_to_ship_routes():
    print('*' * 50)
    print("Creating Report of All Unable to Transport Packages:")
    print('*' * 50)
    print()
    print("{:<11} | {:<25} | {:<30} | {:<20} | {:<15} | {:<21} | {:<15} | {:<30} | {:<9}".format('Package ID',
                                                                                                 'Customer',
                                                                                                 'Package Description',
                                                                                                 'Dangerous Contents',
                                                                                                 'Weight (KGs)',
    ...
    try:
        with open('booking_quotes.csv', 'r') as csvfile:
            ...
            for row in reader:
                route = row['route']
                if route == 'Not Able to Be Shipped':
                    ...
                    print("{:<11} | {:<25} | {:<30} | {:<20} | {:<15} | {:<21} | {:<15} | {:<30} | {:<9}".format(
    ...
    print()
    print('*' * 50)
    print("Unable to Transport Report has been created!")
    print('*' * 50)
